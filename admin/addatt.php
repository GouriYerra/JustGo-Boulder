...
<form action = "addatt.php#" method = "POST">
	...
	<?php
		...
		if(!empty($_POST)){
			...
			$state = $_POST['state'];
			$zip = $_POST['zip'];
			$sql = "INSERT INTO attraction (attractionName, category,
			description, picture, phoneNumber, pricing) VALUES($atName', '$cat', '$des', '$pic', '$phone', '$price')";
			#need to add code to update addresses table too
			echo "read data";
